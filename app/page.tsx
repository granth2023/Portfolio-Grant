      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          ...
          <p className="text-gray-500 dark:text-gray-300 text-center">
            Click
            <a
               href="https://docs.google.com/document/d/1gSJE_YUUYMcXWH85P0wPtbC6L3FqfLsk2koFfEdSGt4/edit?usp=sharing"
              target="_blank"
            >
              {" "}
              <b>here</b>
          ...
          <a href="https://github.com/granth2023" target = "_blank"> 
            ...
            <a href="https://linkedin.com/in/grantharris123" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
            ...
            <a href="mailto:grantharris38@gmail.com" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
